...
pub const LUA_VERSION_RELEASE: &[u8; 2] = b"6\0";
pub const LUA_VERSION_NUM: u32 = 504;
pub const LUA_VERSION_RELEASE_NUM: u32 = 50406;
pub const LUA_VERSION: &[u8; 8] = b"Lua 5.4\0";
pub const LUA_RELEASE: &[u8; 10] = b"Lua 5.4.6\0";
pub const LUA_COPYRIGHT: &[u8; 52] = b"Lua 5.4.6  Copyright (C) 1994-2023 Lua.org, PUC-Rio\0";
...
pub const LUA_VERSUFFIX: &[u8; 5] = b"_5_4\0";
...
fn bindgen_test_layout_luaL_Buffer__bindgen_ty_1() {
    const UNINIT: ::std::mem::MaybeUninit<luaL_Buffer__bindgen_ty_1> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
